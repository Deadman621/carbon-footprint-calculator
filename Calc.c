...
void store(float Total){
    ...
    //FILE *fptr = fopen("Data Base File.txt","w");
...
//     float CurrentHouseholdEmissionTotal =  HouseholdEmission(1000,1000);
//     float CurrentTransportEnergyTotal = TransportEnergy(55.27,500);
//     float CurrentFoodemissionTotal =  Foodemission(90,90,90);

//     int QtyRequested = 23, i;                                
//     float total[QtyRequested];  
                    
//     //store(CurrentHouseholdEmissionTotal+CurrentTransportEnergyTotal+CurrentFoodemissionTotal);

//     retrive(total,&QtyRequested);

//     for(i = 0 ; i < QtyRequested ; i++){
//         printf(" %d : %f\n",i,total[i]); // The most recent total is stored at the largest index
//     }

//     printf("q : %d",QtyRequested);


//     // printf("\n%f",CurrentHouseholdEmissionTotal);
//     // printf("\n%f",CurrentTransportEnergyTotal);
//     // printf("\n%f",CurrentFoodemissionTotal);
